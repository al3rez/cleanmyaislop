  ...
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-12">
      <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
        Expert developers for every AI code nightmare
      </h2>
    </div>
    ...
    <div class="mt-12 text-center">
      <a href="/developers" class="text-emerald-600 hover:text-emerald-700 font-medium inline-flex items-center" plausible-event-name="Navigation+Click" plausible-event-props='{"link":"browse_all_developers"}'>
